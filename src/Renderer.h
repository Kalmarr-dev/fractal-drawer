...
public:
  ...
  void DrawFractalSkeleton(const FractalSkeleton& fractalSkeleton, VertexArray& va, const Shader& shader, const VertexBufferLayout& layout, const float size) const;
